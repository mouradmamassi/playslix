...
export default function NSRStreetCarRacing() {
  // SEO-focused metadata for NSR Street Car Racing
  const pageTitle = "NSR Street Car Racing Game Online - Play Free Car Racing on Playslix.com";
  const pageDescription = "Experience the adrenaline of underground street car racing in NSR Street Car Racing! Customize your ride, dominate the asphalt, and become the king of the streets in this free online game on Playslix.com.";
  const gameName = "NSR Street Car Racing";
  const gameDescription = "NSR Street Car Racing: Experience the adrenaline of underground street car racing in this thrilling, fast-paced, free online game. Customize your high-performance ride, tune it for speed, and dominate the asphalt against fierce competitors. Unleash your inner racer and become the king of the streets, available to play directly in your browser on Playslix.com!";
  const iframeSrc = "https://html5.gamedistribution.com/d632553ef7264d99aa438310073a6dc3/?gd_sdk_referrer_url=https://playslix.com/game/nsr-street-car-racing";
  ...
  useEffect(() => {
    ...
    const addGameSchema = () => {
      ...
      schemaScript.innerHTML = JSON.stringify({
        ...
        "genre": ["Racing", "Car", "Driving", "Action", "Simulation"],
        ...
        "aggregateRating": { // Placeholder: Update with actual ratings if available
          ...
          "ratingValue": "4.7", // Example rating
          "ratingCount": "210"  // Example count
        },
        "image": "https://placehold.co/800x450/1E90FF/FFFFFF?text=NSR+Street+Car+Racing+Game", // Replace with a relevant game screenshot/image
      ...
      <div className="relative w-full max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 bg-white rounded-xl shadow-2xl flex flex-col items-center space-y-6">
        ...
        <main className="flex flex-col items-center justify-center w-full mt-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-indigo-700 mb-4 text-center leading-tight">
            Play <span className="text-blue-600">NSR Street Car Racing</span> Online Free
          </h1>
