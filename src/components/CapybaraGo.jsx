...
export default function CapybaraGoGame() {
  // SEO-focused metadata for Capybara Go!
  const pageTitle = "Capybara Go! Game Online - Play Free Endless Runner on Playslix.com";
  const pageDescription = "Embark on an adorable adventure with Capybara Go! Explore vibrant worlds, collect items, and overcome obstacles in this fun, free online endless runner game. Play now on Playslix.com!";
  const gameName = "Capybara Go!";
  const gameDescription = "Capybara Go!: Embark on an adorable adventure with the internet's favorite giant rodent in this exciting, free online endless runner. Explore vibrant worlds, collect items, and overcome quirky obstacles. A fun-packed game perfect for quick sessions and available to play directly in your browser on Playslix.com!";
  const iframeSrc = "https://html5.gamedistribution.com/63e8c2d0709e452f842f261a7c9f43f9/?gd_sdk_referrer_url=https://playslix.com/game/capybara-go";
  ...
  useEffect(() => {
    ...
    const addGameSchema = () => {
      ...
      schemaScript.innerHTML = JSON.stringify({
        ...
        "genre": ["Endless Runner", "Adventure", "Casual", "Animal"],
        ...
        "aggregateRating": { // Placeholder: Update with actual ratings if available
          ...
          "ratingValue": "4.6", // Example rating
          "ratingCount": "150"  // Example count
        },
        "image": "https://placehold.co/800x450/7ED321/FFFFFF?text=Capybara+Go!+Game", // Replace with a relevant game screenshot/image
      ...
      <div className="relative w-full max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 bg-white rounded-xl shadow-2xl flex flex-col items-center space-y-6">
        ...
        <main className="flex flex-col items-center justify-center w-full mt-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-indigo-700 mb-4 text-center leading-tight">
            Play <span className="text-lime-600">Capybara Go!</span> Online Free
          </h1>
